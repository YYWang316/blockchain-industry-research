...
This file exists **only** so Claude Code's project-scoped skill discovery (`.claude/skills/`) finds and triggers Stack Anamnesis from a deterministic location. It has no body content of its own — the canonical skill is at the repository root.
